...
const instagramlu = 'https://instagram.com/itsmeikyxsec404'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/+6281281872699'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung Jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/Hc3WJvWDziF3u63gCeCtI7'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/Hc3WJvWDziF3u63gCeCtI7'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => RMS BOT WHATSAPP`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => RMS BOT WHATSAPP`)
})
...
conn.sendMessage(id, 'Apan Su Pape Pape Ketik #help Untuk Melihat Berbagai Macam Fitur' ,MessageType.text);
}
else if (text == 'P'){
